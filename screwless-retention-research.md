...
The rounded vent-frame cage remains the preferred enclosed/aesthetic experiment. Its continuous frame provides broad top and bottom capture without small snap features. Physical coupons now validate snug fits for both devices: the Green uses 0.30 mm nominal side clearance with 0.10 mm roof clearance, and the TP-Link uses 0.10 mm side clearance with 0.05 mm roof clearance. Without moving the device or LED opening, the Green's 1.6 mm roof ends at Z=44.0625 mm, leaving 0.3875 mm below the exact 44.45 mm panel outline. The fit profile remains constant from front to rear; square rear seams keep the roof, floor, and side frames flush without a separate flare. The remaining coupon-gated uncertainty is the optional dovetail rail lock, not either device cavity.
...
- The revised Green hybrid prototype reaches 43.8875 mm, leaving 0.5625 mm below the exact 44.45 mm panel top.

Physical TP-Link measurements from the unit on hand use 1/32-inch ruler increments: 53.975 mm maximum width (2 1/8 in), a revised 48.41875 mm flat plateau width (1 29/32 in), 24.60625 mm total height (31/32 in), and an 18.25625 mm straight side band (23/32 in). The enclosure is symmetric top-to-bottom, so the remaining height is divided into equal 3.175 mm (1/8 in) vertical bevel traversals. Both plateaus are inset 2.778125 mm (7/64 in) per side. The measured 67.46875 mm length (2 21/32 in) remains modeled as the flat plateau length, not the full housing; TP-Link publishes an 80.8 mm overall length, leaving matching 6.665625 mm longitudinal bevels at each end of both plateaus.
...
6. **Rounded vent-frame rear-loading cages** — best aesthetics and broad capture with large vents. The 1.6 mm preloaded roof stays below the exact 44.45 mm faceplate outline, but full-length fit remains sensitive to tolerance and creep.
...
An independent stronger branch was prototyped without copying the licensed mesh: separate Green and TP-Link gates use a shared 60-degree dovetail standard, 2.8 mm rail depth, 2.6 mm neck, 5.8 mm head, 0.25 mm running clearance per flank, and a final 7 mm wedge zone closing to a nominal line fit. A 1.2 mm blind bottom stop and top lead-in avoid thin spring tabs; the exposed top bar remains available for deliberate removal. The straight receiver tracks are now buried inside locally thickened rear sidewall ends rather than extended behind the cage. Each H-frame slides through a shallow rear pocket and finishes flush with the cage's rear face while the wider dovetail heads remain captured farther forward in the wall. The revised gate replaces the two anti-rattle pads with one smooth lower crossbeam positioned 0.05 mm behind the device's solid lower rear face. A shallow bevel spans the complete beam rather than concentrating force at small tabs, and one clean rear opening replaces the two narrow pad slots. The central connector field stays open, but cables must be disconnected while sliding the gate. Discrete cage collision checks at 0, 1, 7, 20, and 40 mm of gate lift are empty for both devices; the installed gates also clear the modeled connector bodies. Standalone gate exports are rotated broad rear face down instead of balancing on a 2.4 mm edge. If pursued, first print the rail coupon with 0.00, 0.05, and 0.10 mm final wedge clearances.
...
- TP-Link bevels: symmetric 3.175 mm upper and lower vertical traversals. The plateau is inset 2.778125 mm per side. The rounded cage follows that profile with 0.10 mm side clearance and 0.05 mm roof clearance; the separate legacy/direct tray still retains its own 0.05 mm-per-side friction setting.
...
- Rounded vent-frame sleeves: 1.6 mm honeycomb roofs with 5 mm borders and aligned raised 3 mm honeycomb floors. Both device floors and the connecting bridge finish at Z=9.025 mm without separate riser columns. The Green side frames follow the measured 111.125 mm bottom for the first 6.35 mm, then taper continuously to the 107.95 mm top plateau; they use 2.4 mm frame thickness, 0.30 mm nominal side clearance, 0.10 mm roof clearance, one approximately 99.8 × 21 mm capsule opening, and 8 mm end blocks. The TP-Link follows the revised 53.975/48.41875/24.60625 mm bevel profile with 0.10 mm side clearance and 0.05 mm roof clearance, one approximately 72.6 × 13 mm capsule opening, and 7 mm end blocks. Both sleeves keep the same profile front-to-rear and use front-rounded/rear-square outlines so roof, floor, and walls meet flush at the rear. The Green roof ends at Z=44.0625 mm, leaving 0.3875 mm below the exact 44.45 mm panel outline; the TP-Link roof ends at Z=35.28125 mm. Both sleeves omit fixed rear stops for axial loading.
- Rounded vent-frame coupon: an exact 5 mm crop from the solid rear border of each complete cage, including the production floor, side-frame, roof, taper, and bevel contact surfaces but ending before the honeycomb openings begin. The revised Green band is approximately 116.53 × 38.04 × 5 mm and 4.7 g of PETG by mesh volume; the revised TP-Link band is approximately 59.78 × 29.26 × 5 mm and 2.7 g. The combined two-object plate is approximately 184.3 × 38.04 × 5 mm and 7.4 g. The shorter band minimizes material while preserving the critical fit cross-section; because it flexes more readily than the full cage, it is a dimensional screening gauge rather than a final extraction-force test.
...
1. Print the combined `vent_frame_coupon.3mf`; it contains mechanically independent, exact 5 mm solid rear-border crops of the Green and TP-Link rounded cages and is already oriented for the intended faceplate-down layer direction.
2. Slide each device into its matching band only far enough to engage the complete constant-clearance profile. Stop if insertion requires excessive force or the frame whitens.

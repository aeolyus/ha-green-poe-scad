...
The rounded vent-frame cage remains the preferred enclosed/aesthetic experiment. Its continuous frame provides broad top and bottom capture without small snap features. The first physical coupon was too narrow in both width and height for the Green and TP-Link. The revised cages therefore use 0.10 mm nominal clearance per side and above each measured enclosure rather than deliberate interference. Without moving the device or LED opening, the Green's 1.6 mm roof now ends at Z=44.0625 mm, leaving 0.3875 mm below the exact 44.45 mm panel outline. The fit profile remains constant from front to rear; square rear seams keep the roof, floor, and side frames flush without a separate flare. Treat it as coupon-gated until the revised clearance is physically confirmed.
...
An independent stronger branch was prototyped without copying the licensed mesh: separate Green and TP-Link gates use a shared 60-degree dovetail standard, 2.8 mm rail depth, 2.6 mm neck, 5.8 mm head, 0.25 mm running clearance per flank, and a final 7 mm wedge zone tightening to 0.10 mm per flank. A 1.2 mm blind bottom stop, top lead-in, and rear pull ledge avoid thin spring tabs. The initial receiver towers projected outside the cage walls because their complete 8.7 mm width could not fit inside a 2.4 mm side frame without entering the device cavity. The revised branch moves the dovetail station 3.5 mm rearward and recesses each receiver entirely inside the cage's outer wall plane. The additional thickness now occupies empty space behind the device; the gate contact pads move inward to remain separate from the receivers and clear the connector field. If pursued, first print the rail coupon with 0.10, 0.15, and 0.20 mm final wedge clearances.
...
- TP-Link bevels: symmetric 3.175 mm upper and lower vertical traversals. The plateau is inset 2.778125 mm per side. The rounded cage follows that profile with 0.10 mm side and roof clearance; the separate legacy/direct tray still retains its own 0.05 mm-per-side friction setting.
...
- Rounded vent-frame sleeves: 1.6 mm honeycomb roofs with 5 mm borders and aligned raised 3 mm honeycomb floors. Both device floors and the connecting bridge finish at Z=9.025 mm without separate riser columns. The Green side frames follow the measured 111.125 mm bottom for the first 6.35 mm, then taper continuously to the 107.95 mm top plateau; they use 2.4 mm frame thickness, 0.10 mm nominal side/roof clearance, one approximately 99.8 × 21 mm capsule opening, and 8 mm end blocks. The TP-Link follows the revised 53.975/48.41875/24.60625 mm bevel profile with the same 0.10 mm side/roof clearance, one approximately 72.6 × 13 mm capsule opening, and 7 mm end blocks. Both sleeves keep the same profile front-to-rear and use front-rounded/rear-square outlines so roof, floor, and walls meet flush at the rear. The Green roof ends at Z=44.0625 mm, leaving 0.3875 mm below the exact 44.45 mm panel outline; the TP-Link roof ends at Z=35.33125 mm. Both sleeves omit rear stops for axial loading.
- Rounded vent-frame coupon: an exact 5 mm crop from the solid rear border of each complete cage, including the production floor, side-frame, roof, taper, and bevel contact surfaces but ending before the honeycomb openings begin. The revised-clearance Green band is approximately 116.13 × 38.24 × 5 mm and 4.7 g of PETG by mesh volume; the revised TP-Link band is approximately 59.78 × 29.31 × 5 mm and 2.7 g. The combined two-object plate is approximately 183.9 × 38.24 × 5 mm and 7.4 g. The shorter band minimizes material while preserving the critical fit cross-section; because it flexes more readily than the full cage, it is a dimensional screening gauge rather than a final extraction-force test.

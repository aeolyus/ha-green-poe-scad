...
The rounded vent-frame cage remains the preferred enclosed/aesthetic experiment. Its continuous frame provides broad top and bottom capture without small snap features. After physical coupon testing, the Green uses 0.20 mm nominal side clearance and retains its accepted 0.10 mm roof clearance. The TP-Link retains its accepted 0.10 mm side clearance while its flexible roof closes to 0.05 mm clearance for slightly more grip. Without moving the device or LED opening, the Green's 1.6 mm roof ends at Z=44.0625 mm, leaving 0.3875 mm below the exact 44.45 mm panel outline. The fit profile remains constant from front to rear; square rear seams keep the roof, floor, and side frames flush without a separate flare. Treat it as coupon-gated until the revised clearance is physically confirmed.

...
- Rounded vent-frame coupon: an exact 10 mm crop from the rear of each complete cage, including floor, side frames, roof, and bevel profile. The Green coupon is approximately 115.73 × 37.74 × 10 mm and 7.5 g of PETG by mesh volume; the TP-Link coupon is approximately 59.78 × 28.41 × 10 mm and 4.8 g. The combined plate remains two separate closed manifold objects, approximately 183.5 × 37.74 × 10 mm and 12.3 g total.
...
1. Print the combined `vent_frame_coupon.3mf`; it contains mechanically independent, exact 10 mm rear crops of the Green and TP-Link rounded cages and is already oriented for the intended faceplate-down layer direction.

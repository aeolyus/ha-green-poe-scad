...
The rounded vent-frame cage remains the preferred enclosed/aesthetic experiment. Its continuous frame provides broad top and bottom capture without small snap features. Without moving the device or LED opening, the Green uses a 1.6 mm roof with 0.4 mm nominal vertical preload. Its top is Z=43.5625 mm, leaving 0.8875 mm below the exact 44.45 mm panel outline. The fit profile remains constant from front to rear; square rear seams keep the roof, floor, and side frames flush without a separate flare. Treat it as coupon-gated until that preload is physically confirmed.
...
- Rounded vent-frame sleeves: 1.6 mm honeycomb roofs with 5 mm borders and aligned raised 3 mm honeycomb floors. Both device floors and the connecting bridge finish at Z=9.025 mm without separate riser columns. The Green side frames follow the measured 111.125 mm bottom for the first 6.35 mm, then taper continuously to the 107.95 mm top plateau; they use 2.4 mm frame thickness, 0.4 mm nominal vertical roof preload, one approximately 99.8 × 21 mm capsule opening, and 8 mm end blocks. The TP-Link uses one approximately 72.6 × 13 mm capsule opening with 7 mm end blocks and zero nominal roof gap. Both sleeves keep the same snug profile front-to-rear and use front-rounded/rear-square outlines so roof, floor, and walls meet flush at the rear. The Green roof ends at Z=43.5625 mm, leaving 0.8875 mm below the exact 44.45 mm panel outline; the TP-Link roof ends at Z=34.4375 mm. Both sleeves omit rear stops for axial loading.
- Rounded vent-frame coupon: an exact 5 mm crop from the solid rear border of each complete cage, including the production floor, side-frame, roof, taper, and bevel contact surfaces but ending before the honeycomb openings begin. The Green band is approximately 115.73 × 37.74 × 5 mm and 4.7 g of PETG by mesh volume; the TP-Link band is approximately 59.78 × 28.41 × 5 mm and 2.8 g. The combined two-object plate is approximately 183.5 × 37.74 × 5 mm and 7.4 g. The shorter band minimizes material while preserving the critical fit cross-section; because it flexes more readily than the full cage, it is a dimensional screening gauge rather than a final extraction-force test.

...
RETENTION_OPTIONS = [
    ...
    },
    {
        ...
        "note": (
            ...
            "leaves the connector field open. Its narrow travel opening is "
            "covered by the seated gate's thin stepped top cap, leaving only "
            "a 0.02 mm separation while keeping the cage roof visually "
            "continuous. The final 7 mm of rail travel "
            "still wedges to a "
...
VARIANTS = [
    ...
    },
    {
        ...
        "device": "tplink",
        "device_name": "TP-Link TL-PD30G-M2",
        "label": "Bottom-aligned unified frame",
        "setback": "60 mm setback · device floors aligned",
        "dimensions": "254 W × 44.45 H × 143.7 D mm",
        "note": (
...
VARIANT_MEASUREMENTS = {
    ...
    "unified_roof": {
        ...
        "clearance_label": "Panel → PoE face",
        "clearance_mm": 57.0,
        "clearance_detail": "Green roof above PoE roof",

...
RETENTION_OPTIONS = [
    ...
    },
    {
        ...
        "note": (
            ...
            "After the first physical coupon proved tight, both cages use "
            "0.10 mm nominal clearance per side and above the measured "
            "devices. Without moving the Green or LEDs, its 1.60 mm roof "
    ...
    },
    {
        ...
        "note": (
            ...
            "planes and shifted 3.5 mm rearward, eliminating the earlier "
            "external brim without reducing device clearance. "

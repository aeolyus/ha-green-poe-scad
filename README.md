...
- `viewer/viewer_retention_ventilated_sleeves.stl` — layout-specific rear-loading sleeve study with honeycomb roofs/floors, four Green support pads, and sparse vertical posts around large open side bays; no horizontal side rails, springs, or relief slots

...
- `vent_frame_coupon.stl` / `.3mf` — the recommended low-material rounded-cage fit test containing both production-derived solid bands as separate objects; approximately 183.5 × 37.74 × 5 mm and 7.4 g of PETG by mesh volume
